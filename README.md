...
I currently exist in a superposition of *writing new features* and *debugging (my) legacy code*, my code both works (most of the times) and doesn't work until you observe it. 

> *"Exploring the codebase of the cosmos, one pull request and star at a time..."*
